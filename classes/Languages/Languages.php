...
//        $this->loadLanguageFiles();
    ...
    private function setLoader() {
        $this->trans->addLoader('php', new \Symfony\Component\Translation\Loader\PhpFileLoader());
    }
...
//            return $this;
//        } else {
            $this->trans->addResource('php', APP_ROOT . '/translations/messages.'. strtolower( str_replace('-', '_', $this->language) ) .'.php', $this->language);
            return $this;
//        }
